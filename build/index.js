...
const toolDefinitionMap = new Map([
    ["getaccount", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" } } },
            method: "get",
            pathTemplate: "/account",
            executionParameters: [{ "name": "api_key", "in": "query" }],
    ...
    ["getdevices", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string" }, "take": { "type": "number", "format": "int32", "description": "Optional number of items to return" }, "page": { "type": "number", "format": "int32", "description": "Optional number of page to return" }, "device_type_id": { "type": "string", "description": "Optional device type Id" }, "group_id": { "type": "array", "items": { "type": "string" }, "description": "Optional media group Id" }, "group_name": { "type": "array", "items": { "type": "string" }, "description": "Optional group name to filter by" }, "include_snap": { "type": "boolean", "default": false, "description": "Optional include snapshot of currently playing content" }, "org_id": { "type": "string", "description": "Optional organization Id to filter by" } } },
            method: "get",
            pathTemplate: "/devices",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "query" }, { "name": "take", "in": "query" }, { "name": "page", "in": "query" }, { "name": "device_type_id", "in": "query" }, { "name": "group_id", "in": "query" }, { "name": "group_name", "in": "query" }, { "name": "include_snap", "in": "query" }, { "name": "org_id", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["postdevice", {
    ...
    ["getdevicebyid", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Device Id" } }, "required": ["id"] },
            method: "get",
            pathTemplate: "/devices/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["putdevice", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Device Id" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The device name" }, "tags": { "type": ["string", "null"], "description": "Tags associated with this device" }, "timeZone": { "type": ["string", "null"], "description": "The timezone of the device" }, "language_code": { "type": ["string", "null"], "description": "The language code of the device" }, "group_id": { "type": ["string", "null"], "description": "The group id" }, "last_service": { "type": ["string", "null"], "description": "The last service date", "format": "date-time" }, "mac_address": { "type": ["string", "null"], "description": "The MAC address of this device, is applicable" }, "location": { "type": "object", "properties": { "city": { "type": ["string", "null"], "description": "City" }, "state": { "type": ["string", "null"], "description": "State" }, "county": { "type": ["string", "null"], "description": "County" }, "country": { "type": ["string", "null"], "description": "Country" }, "postal_code": { "type": ["string", "null"], "description": "Postal code" }, "address": { "type": ["string", "null"], "description": "Address" }, "latitude": { "type": ["number", "null"], "description": "Latitude", "format": "double" }, "longitude": { "type": ["number", "null"], "description": "Longitude", "format": "double" } }, "additionalProperties": false }, "beacon": { "type": "object", "properties": { "distance": { "type": ["number", "null"], "format": "double" }, "calibration": { "type": ["number", "null"], "format": "double" }, "phone": { "type": ["string", "null"] }, "emailAddress": { "type": ["string", "null"] }, "website": { "type": ["string", "null"] }, "devices": { "type": ["array", "null"], "items": { "type": "string" } }, "rating": { "type": ["number", "null"], "format": "double" }, "uuid": { "type": ["string", "null"] }, "major": { "type": ["string", "null"] }, "minor": { "type": ["string", "null"] }, "notification_delay": { "type": ["number", "null"], "format": "int32" }, "instance_id": { "type": ["string", "null"] }, "namespace": { "type": ["string", "null"] } }, "additionalProperties": false } }, "additionalProperties": false, "description": "Device" } }, "required": ["id"] },
            method: "put",
            pathTemplate: "/devices/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: "application/json",
...
Uses the JSON Patch syntax (http://jsonpatch.com)`,
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Device Id" }, "requestBody": { "type": "string", "description": "Request body (content type: application/json-patch+json)" } }, "required": ["id"] },
            method: "patch",
            pathTemplate: "/devices/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
    ...
    ["getdevicegroups", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "tree": { "type": "boolean", "default": false, "description": "Optional hierarchical data format" }, "id": { "type": "string", "description": "Optional group id" }, "take": { "type": "number", "format": "int32", "description": "Optional number of items to return" }, "page": { "type": "number", "format": "int32", "description": "Optional number of page to return" } } },
            method: "get",
            pathTemplate: "/devices/groups",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "tree", "in": "query" }, { "name": "id", "in": "query" }, { "name": "take", "in": "query" }, { "name": "page", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["postdevicegroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The group name" } }, "additionalProperties": false, "description": "Device group" } } },
            method: "post",
            pathTemplate: "/devices/groups",
            executionParameters: [{ "name": "api_key", "in": "query" }],
            requestBodyContentType: "application/json",
    ...
    ["putdevicegroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Group id" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The group name" } }, "additionalProperties": false, "description": "Device group" } }, "required": ["id"] },
            method: "put",
    ...
    ["deletedevicegroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Device group Id" } }, "required": ["id"] },
            method: "delete",
            pathTemplate: "/devices/groups/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: undefined,
    ...
    ["getpingdata", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "key": { "type": "string", "description": "Registration key" } } },
            method: "get",
            pathTemplate: "/devices/pingdata",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "key", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["getsnapshot", {
    ...
    ["postdevicescommands", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "requestBody": { "type": "array", "items": { "type": "object", "properties": { "deviceId": { "type": ["string", "null"] }, "commands": { "type": ["array", "null"], "items": { "type": "object", "properties": { "name": { "type": "string", "nullable": true }, "arg": { "type": "string", "nullable": true } }, "additionalProperties": false } } }, "additionalProperties": false }, "description": "Command set" } } },
            method: "post",
    ...
    ["postdevicecommands", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Device Id" }, "requestBody": { "type": "array", "items": { "type": "object", "properties": { "name": { "type": ["string", "null"] }, "arg": { "type": ["string", "null"] } }, "additionalProperties": false }, "description": "Commands" } }, "required": ["id"] },
            method: "post",
    ...
    ["postevent", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Device Id" }, "requestBody": { "type": "object", "properties": { "session_id": { "type": ["string", "null"] }, "event_name": { "type": ["string", "null"] }, "properties": { "type": ["object", "null"], "additionalProperties": { "nullable": true } } }, "additionalProperties": false, "description": "Event" } }, "required": ["id"] },
            method: "post",
    ...
    ["getmedia", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Optional Media Id" }, "take": { "type": "number", "format": "int32", "description": "Optional number of items to return" }, "page": { "type": "number", "format": "int32", "description": "Optional number of page to return" }, "group_id": { "type": "array", "items": { "type": "string" }, "description": "Optional media group Id" }, "group_name": { "type": "array", "items": { "type": "string" }, "description": "Optional group name to filter by" } } },
            method: "get",
            pathTemplate: "/media",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "query" }, { "name": "take", "in": "query" }, { "name": "page", "in": "query" }, { "name": "group_id", "in": "query" }, { "name": "group_name", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["postmediamultipart", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "requestBody": { "type": "string", "description": "Request body (content type: multipart/form-data)" } } },
            method: "post",
            pathTemplate: "/media",
            executionParameters: [{ "name": "api_key", "in": "query" }],
    ...
    ["getmediabyid", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Media Id" } }, "required": ["id"] },
            method: "get",
    ...
    ["deletemedia", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string" } }, "required": ["id"] },
            method: "delete",
            pathTemplate: "/media/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: undefined,
...
Uses the JSON Patch syntax (http://jsonpatch.com)`,
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Media Id" }, "requestBody": { "type": "string", "description": "Patch update" } }, "required": ["id"] },
            method: "patch",
            pathTemplate: "/media/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: "application/json-patch+json",
    ...
    ["postmediagroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The group name" } }, "additionalProperties": false, "description": "Media group" } } },
            method: "post",
            pathTemplate: "/media/groups",
            executionParameters: [{ "name": "api_key", "in": "query" }],
            requestBodyContentType: "application/json",
    ...
    ["putmediagroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Group id" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The group name" } }, "additionalProperties": false, "description": "Media group" } }, "required": ["id"] },
            method: "put",
    ...
    ["deletemediagroup", {
            ...
            description: `Group must be empty.`,
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Media group Id" } }, "required": ["id"] },
            method: "delete",
            pathTemplate: "/media/groups/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: undefined,
    ...
    ["postmediaimport", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "url": { "type": "string", "description": "URL of the file to import" }, "group_id": { "type": "string", "description": "Media group Id" } } },
            method: "post",
            pathTemplate: "/media/import",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "url", "in": "query" }, { "name": "group_id", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["getplaylists", {
    ...
    ["getplaylistbyid", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Playlist Id" } }, "required": ["id"] },
            method: "get",
...
Uses the JSON Patch syntax (http://jsonpatch.com)`,
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Playlist Id" }, "requestBody": { "type": "string", "description": "Patch document" } }, "required": ["id"] },
            method: "patch",
            pathTemplate: "/playlists/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: "application/json-patch+json",
    ...
    ["postplaylistgroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The group name" } }, "additionalProperties": false, "description": "Playlist group" } } },
            method: "post",
            pathTemplate: "/playlists/groups",
            executionParameters: [{ "name": "api_key", "in": "query" }],
            requestBodyContentType: "application/json",
    ...
    ["deleteplaylistgroup", {
            ...
            description: `Group must be empty.`,
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Playlist group Id" } }, "required": ["id"] },
            method: "delete",
            pathTemplate: "/playlists/groups/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: undefined,
    ...
    ["getimpressionsbygenderreport", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string" }, "start": { "type": "string", "format": "date-time" }, "end": { "type": "string", "format": "date-time" }, "gender": { "type": "array", "items": { "type": "string" } }, "device_id": { "type": "array", "items": { "type": "string" } }, "compare_start": { "type": "string", "format": "date-time" }, "compare_end": { "type": "string", "format": "date-time" } } },
            method: "get",
            pathTemplate: "/report/adhawk/impressions-by-gender",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "start", "in": "query" }, { "name": "end", "in": "query" }, { "name": "gender", "in": "query" }, { "name": "device_id", "in": "query" }, { "name": "compare_start", "in": "query" }, { "name": "compare_end", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ...
    ["getreportbyid", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Optional report id filter" } } },
            method: "get",
            pathTemplate: "/report",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["postreportexport", {
    ...
    ["exportreport", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string" }, "report_id": { "type": "string" }, "format": { "enum": ["XML", "CSV", "IMAGE", "PDF", "EXCEL", "WORD", "HTML", "MHTML"], "type": "string" }, "activity_type": { "type": "string" }, "interval": { "enum": ["Minute", "Hour", "Day", "Month"], "type": "string", "description": "Duration interval to generate the report for" }, "start": { "type": "string", "format": "date-time" }, "end": { "type": "string", "format": "date-time" }, "device_id": { "type": "array", "items": { "type": "string" } }, "user_id": { "type": "array", "items": { "type": "string" } }, "media_id": { "type": "array", "items": { "type": "string" } } }, "required": ["report_id"] },
            method: "get",
            pathTemplate: "/report/export/{report_id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "report_id", "in": "path" }, { "name": "format", "in": "query" }, { "name": "activity_type", "in": "query" }, { "name": "interval", "in": "query" }, { "name": "start", "in": "query" }, { "name": "end", "in": "query" }, { "name": "device_id", "in": "query" }, { "name": "user_id", "in": "query" }, { "name": "media_id", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["getschedules", {
            ...
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "query" }, { "name": "take", "in": "query" }, { "name": "page", "in": "query" }, { "name": "group_id", "in": "query" }, { "name": "group_name", "in": "query" }, { "name": "device_id", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["postschedule", {
    ...
    ["getschedulebyid", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Schedule Id" } }, "required": ["id"] },
            method: "get",
    ...
    ["putschedule", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API Key" }, "id": { "type": "string", "description": "Schedule Id" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The name of the schedule" }, "group_id": { "type": ["string", "null"], "description": "The group id to which the schedule belongs" }, "tags": { "type": ["string", "null"], "description": "The tags associated with the schedule" }, "monday": { "type": ["boolean", "null"], "description": "Enabled this schedule for playback on Monday.\r\nOnly applicable for Playlist and Template schedules." }, "tuesday": { "type": ["boolean", "null"], "description": "Enabled this schedule for playback on Tuesday.\r\nOnly applicable for Playlist and Template schedules." }, "wednesday": { "type": ["boolean", "null"], "description": "Enabled this schedule for playback on Wednesday.\r\nOnly applicable for Playlist and Template schedules." }, "thursday": { "type": ["boolean", "null"], "description": "Enabled this schedule for playback on Thursday.\r\nOnly applicable for Playlist and Template schedules." }, "friday": { "type": ["boolean", "null"], "description": "Enabled this schedule for playback on Friday.\r\nOnly applicable for Playlist and Template schedules." }, "saturday": { "type": ["boolean", "null"], "description": "Enabled this schedule for playback on Saturday.\r\nOnly applicable for Playlist and Template schedules." }, "sunday": { "type": ["boolean", "null"], "description": "Enabled this schedule for playback on Sunday.\r\nOnly applicable for Playlist and Template schedules." }, "start_date": { "type": ["string", "null"], "description": "The start date for the schedule.\r\nOnly applicable for Playlist and Template schedules." }, "end_date": { "type": ["string", "null"], "description": "The end date for the schedule.\r\nOnly applicable for Playlist and Template schedules." }, "start_time": { "type": ["string", "null"], "description": "The start time for the schedule.\r\nOnly applicable for Playlist and Template schedules." }, "end_time": { "type": ["string", "null"], "description": "The end time for the schedule.\r\nOnly applicable for Playlist and Template schedules." }, "template_id": { "type": ["string", "null"], "description": "The template id for the schedule.\r\nOnly applicable for Playlist and Template schedules." }, "playlist_id": { "type": ["string", "null"], "description": "The playlist id for the schedule.\r\nOnly applicable for Playlist and Template schedules." }, "type": { "enum": ["Playlist", "Template", "Campaign"], "type": "string" }, "devices": { "type": ["array", "null"], "items": { "type": "object", "properties": { "id": { "type": "string", "description": "The device id", "nullable": true } }, "additionalProperties": false }, "description": "The devices associated with the schedule." }, "conditions": { "type": ["array", "null"], "items": { "type": "object", "properties": { "type": { "enum": ["AfterDate", "AfterTime", "Always", "BeforeDate", "BeforeTime", "Command", "DateRange", "DayOfMonth", "DaysOfWeek", "DeviceByGroup", "DeviceByNestedGroup", "DeviceByName", "DeviceByTag", "DeviceByOrg", "Everywhere", "GeoLocation", "GpsWithinRadius", "KeyEvent", "MonthOfYear", "Motion", "Never", "Nowhere", "PctAdult", "PctChild", "PctFemale", "PctMale", "PctSenior", "PctYoung", "PctYoungAdult", "PlaylistByName", "PlaylistByTag", "SendCommand", "SpecificDevice", "SpecificPlaylist", "SpecificTemplate", "SpecificZone", "TemplateByName", "TemplateByTag", "TimeRange", "TopicSet", "TotalViewersGreaterThan", "TotalViewersLessThan", "TouchEvent", "WeekOfMonth", "WeekOfYear"], "type": "string" }, "operator": { "enum": ["And", "Or", "AndNot", "OrNot"], "type": "string" }, "value_1": { "type": "string", "description": "Value 1", "nullable": true }, "value_2": { "type": "string", "description": "Value 2", "nullable": true }, "value_3": { "type": "string", "description": "Value 3", "nullable": true }, "value_4": { "type": "string", "description": "Value 4", "nullable": true } }, "additionalProperties": false }, "description": "The conditions associated with the schedule.\r\nOnly applicable for Campaign schedules." }, "priority": { "enum": ["Normal", "High", "Highest", "Lowest", "Low"], "type": "string" } }, "additionalProperties": false, "description": "Schedule model" } }, "required": ["id"] },
            method: "put",
            pathTemplate: "/schedules/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: "application/json",
...
Uses the JSON Patch syntax (http://jsonpatch.com)`,
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Schedule Id" }, "requestBody": { "type": "string", "description": "Patch update" } }, "required": ["id"] },
            method: "patch",
            pathTemplate: "/schedules/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: "application/json-patch+json",
    ...
    ["postschedulegroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The group name" } }, "additionalProperties": false, "description": "Schedule group" } } },
            method: "post",
            pathTemplate: "/schedules/groups",
            executionParameters: [{ "name": "api_key", "in": "query" }],
            requestBodyContentType: "application/json",
    ...
    ["putschedulegroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Schedule group Id" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The group name" } }, "additionalProperties": false, "description": "Schedule group" } }, "required": ["id"] },
            method: "put",
    ...
    ["deleteschedulegroup", {
            ...
            description: `Group must be empty.`,
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API Key" }, "id": { "type": "string", "description": "Schedule group Id" } }, "required": ["id"] },
            method: "delete",
            pathTemplate: "/schedules/groups/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: undefined,
    ...
    ["gettemplatebyid", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Template Id" } }, "required": ["id"] },
            method: "get",
    ...
    ["posttemplategroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The group name" } }, "additionalProperties": false, "description": "Template group" } } },
            method: "post",
            pathTemplate: "/templates/groups",
            executionParameters: [{ "name": "api_key", "in": "query" }],
            requestBodyContentType: "application/json",
    ...
    ["puttemplategroup", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Group id" }, "requestBody": { "type": "object", "properties": { "name": { "type": ["string", "null"], "description": "The group name" } }, "additionalProperties": false, "description": "Template group" } }, "required": ["id"] },
            method: "put",
    ...
    ["deletetemplategroup", {
            ...
            description: `Group must be empty.`,
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Template group Id" } }, "required": ["id"] },
            method: "delete",
            pathTemplate: "/templates/groups/{id}",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "path" }],
            requestBodyContentType: undefined,
    ...
    ["getusers", {
            ...
            inputSchema: { "type": "object", "properties": { "api_key": { "type": "string", "description": "API key" }, "id": { "type": "string", "description": "Optional User Id to filter by" }, "take": { "type": "number", "format": "int32", "description": "Optional number of items to return" }, "page": { "type": "number", "format": "int32", "description": "Optional number of page to return" } } },
            method: "get",
            pathTemplate: "/users",
            executionParameters: [{ "name": "api_key", "in": "query" }, { "name": "id", "in": "query" }, { "name": "take", "in": "query" }, { "name": "page", "in": "query" }],
            requestBodyContentType: undefined,
            securityRequirements: [{ "Bearer": ["webapi"] }, { "ApiKeyInHeader": [] }, { "ApiKeyInQuery": [] }]
        }],
    ["getuserbyid", {
