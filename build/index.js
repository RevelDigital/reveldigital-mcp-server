...
Uses the JSON Patch syntax (http://jsonpatch.com)`,
    ...
    ["postreportexport", {
            ...
            inputSchema: { "type": "object", "properties": { "exclude_body": { "type": "boolean", "description": "Exclude the generated report body in the response.\r\n            This report is always available at the URL provided in the X-RevelDigital-GeneratedReportUrl response header value." }, "requestBody": { "required": ["report_id"], "type": "object", "properties": { "report_id": { "type": ["string", "null"], "description": "Report name" }, "format": { "enum": ["XML", "CSV", "IMAGE", "PDF", "EXCEL", "WORD", "HTML", "MHTML"], "type": "string" }, "activity_type": { "type": ["string", "null"], "description": "Activity type" }, "interval_type": { "enum": ["Minute", "Hour", "Day", "Month"], "type": "string", "description": "Duration interval to generate the report for" }, "start_date": { "type": ["string", "null"], "description": "Report start date.\r\n\r\nProvide in ISO 8601 format: YYYY-MM-DDThh:mm:ssZ", "format": "date-time" }, "end_date": { "type": ["string", "null"], "description": "Report end date.\r\n\r\nProvide in ISO 8601 format: YYYY-MM-DDThh:mm:ssZ", "format": "date-time" }, "start_time": { "type": ["string", "null"], "description": "Report start time.\r\n\r\nProvide in ISO 8601 format: YYYY-MM-DDThh:mm:ssZ", "format": "date-time" }, "end_time": { "type": ["string", "null"], "description": "Report end time.\r\n\r\nProvide in ISO 8601 format: YYYY-MM-DDThh:mm:ssZ", "format": "date-time" }, "device_id": { "type": ["array", "null"], "items": { "type": "string" }, "description": "Array of devices by Id to include in report" }, "user_id": { "type": ["array", "null"], "items": { "type": "string" }, "description": "Array of users by Id to include in report" }, "media_id": { "type": ["array", "null"], "items": { "type": "string" }, "description": "Array of media items by Id to include in report" } }, "additionalProperties": false, "description": "Report parameters" } } },
            method: "post",
...
Uses the JSON Patch syntax (http://jsonpatch.com)`,
    ...
    ["getuserbyid", {
            ...
            inputSchema: { "type": "object", "properties": { "id": { "type": "string", "description": "User Id" } }, "required": ["id"] },
            method: "get",
